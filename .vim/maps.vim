...
vmap <silent> <Leader>p :Silicon /path/to/1.png
vmap <silent> <Leader>P :Silicon Desktop/2.png
...
"Config elimina una linea completa===
nmap - dd

"Limpiar busqueda de palabras
nnoremap <Leader>c :noh<CR>

"Background
" nmap <silent> <Leader>bg :set background=dark<CR>
